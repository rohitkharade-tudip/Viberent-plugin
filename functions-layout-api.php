...
function test_init()
{
    ...
    dbDelta($sql);
    $table_subcategory = $wpdb->prefix . 'viberent_subcategory';
    $sql = "CREATE TABLE $table_subcategory (
...
?>
    <div id="full_page_viberent_plugin">
        ...
        register_activation_hook(BEARDBOT_PLUGIN_FILE, 'create_page');
        ...
        ?>
            <div id="chosen_message" style="display:none;">
                <a href="http://localhost/wpTest/index.php/viberent-based-listing" type="button" target="_blank" id="change_selected_layout" name="change_selected_layout">Go to the <?php echo $my_selected_layout[0]->selected_layout; ?> layout </a>
            </div>
    <?php
        }
    }
